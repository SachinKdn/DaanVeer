            ...
            public void onClick(View v) {
                ...
                database.getReference().child("Organisation").child(auth.getUid()).child("orgName").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        database.getReference().child("Donation").child(donation.getDonatorId()).child("orgName").setValue(orgName);
                        database.getReference().child("UsersDonation").child(donation.getDonatorId()).child(newest).child("orgName").setValue(orgName);
                        database.getReference().child("Donation").child(donation.getDonatorId()).child("organinsation").setValue(auth.getUid());
                        database.getReference().child("UsersDonation").child(donation.getDonatorId()).child(newest).child("organinsation").setValue(auth.getUid());
